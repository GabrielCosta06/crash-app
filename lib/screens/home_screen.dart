              ...
              child: Column(
                ...
                children: <Widget>[
                  _HeroSearch(
                    ...
                    onFindSearch: (query) {
                      if (widget.onFindSearch != null) {
                        widget.onFindSearch!(query);
                      } else {
                        widget.onUpdateIndex?.call(1);
                      }
                    },
